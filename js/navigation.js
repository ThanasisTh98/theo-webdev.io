...
<!-- Example Code Start-->
    <nav class="navbar navbar-dark fixed-top py-4">
      <div class="container-fluid ">
        ...
        <a href="./assets/Thanasis_Theodorou_CV.pdf" class="cv-download-link" target="_blank">
...
function createFooter() {
  return `
    <footer class="bg-footer mt-auto" id="contact" style="background: #F8F6FF;">
      <div class="container px-5 bg-container">
        <div class="row align-items-center justify-content-between flex-column flex-sm-row">
          <div class="col-auto">
            <div class=" m-0"><a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="mailto:thanasisth1998@gmail.com">→ Email</a></div>
            <div class=" m-0"><a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="./assets/Thanasis_Theodorou_CV.pdf">→ Resume</a></div>
            <div class=" m-0"><a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://www.linkedin.com/in/thanasis-theodorou-cy/" target="_blank">→ LinkedIn</a></div>
          </div>
          <div class="col-auto">
            <div class=" m-0"> Last Updated → <strong><span id="lastCommitDate">31/07</span></strong></div>
            <div class=" m-0">@Theo_Theodorou_2024 </div>
          </div>
        </div>
      </div>
    </footer>
